...
void printUsage()
{
    ...
    fprintf(stderr, "    ./gen_test <directory> <exe> <num_of_data>\n\n");
    fprintf(stderr, "    ./gen_test <directory> <exe> <num_from> <num_to>\n\n");

    fprintf(stderr, "        directory: Main directory of file\n");
    fprintf(stderr, "        exe: Testfile generator name\n");
    ...
    fprintf(stderr, "      \\-exe\n");
    fprintf(stderr, "      |-data\n");
    fprintf(stderr, "       \\-1.ans\n");
    fprintf(stderr, "       |-2.ans\n");
    fprintf(stderr, "       |-...ans\n");
...
int main(int argc, char **argv)
{
	...
	{
		sprintf(command, "%s > %s/%d.in", EXE_PATH, FILE_PATH, i); // dir/exe < dir/data/i.in > dir/data/i.ans
		printf("%s...\n", command);
